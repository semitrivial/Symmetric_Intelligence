...
intelligence measure is that it assigns negative intelligence to certain
...
assumption that intelligence never be negative, while leaving aside the
question of whether intelligence need be measured over the reals.}.
We would argue that this makes sense when environments are capable of punishing
