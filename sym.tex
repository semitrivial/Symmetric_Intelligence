...
see Section \ref{absvaluesection}.}, then $\Upsilon$ ought
...
better measure of the agent's sheer ingenuity\footnote{We would note,
...
Paradoxically, such an agent would be hard to distinguish from a mediocre agent that
tries to maximize rewards and ends up with average reward $0.1$ by its mediocrity.},
...
starts giving reward $0$ while simulating $T$ until it halts, finally giving reward $2$
...
We acknowledge Jos{\'e} Hern{\'a}ndez-Orallo, Shane Legg, and Pedro Ortega for
