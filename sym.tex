...
Environments do not take strings from $2^*$ as inputs, and they do not output
strings from $2^*$ either. Rather, they take
elements of $(\mathcal O\mathcal R\mathcal A)^*$ as inputs and they
output $\mathbb Q$-valued probability measures on $\mathcal O\times\mathcal R$.
