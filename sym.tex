...
The sum defining $\Gamma_{\LH}$ is absolutely convergent (a fact used ubiquitously
in Legg and Hutter's paper), and thus the sum defining $\Gamma_{\SYM}$ is also
...
for every environment, in which case the distinction in
