...
\label{omnibusdefn}
    ...
    \begin{enumerate}
        \item
        By $(\mathcal O\times\mathcal R\times\mathcal A)^*$ we mean the set of
        ...
        \item
        By $(\mathcal O\times\mathcal R\times\mathcal A)^*\times \mathcal O\times\mathcal R$
        we mean all sequences of the form $s\frown o\frown r$ where
        $s\in (\mathcal O\times\mathcal R\times\mathcal A)^*$, $o\in\mathcal O$
        and $r\in\mathcal R$ ($\frown$ denotes concatenation).
        \item
        By an \emph{agent}, we mean a function $\pi$ which assigns to every sequence
        $s\in (\mathcal O\times\mathcal R\times\mathcal A)^*\times \mathcal O\times\mathcal R$ a $\mathbb Q$-valued probability measure,
        ...
        $s\in (\mathcal O\times\mathcal R\times\mathcal A)^*$
