...
Likewise, fix prefix-free codes $\ulcorner m\urcorner$ for all
rational-valued probability-measures $m$ on $\mathcal O\times\mathcal R$.
...
\label{envirosymmexistencelemma}
    ...
    \begin{enumerate}
        ...
        for some $\mathbb Q$-valued probability-measure $m$
        on $\mathcal O\times\mathcal R$,
        then let $U(x)=\ulcorner m'\urcorner$, where
        $m'$ is the rational-valued probability-measure
        $m'(o,r)=m(o,-r)$.
        Otherwise, $U(x)$ is undefined.
    \end{enumerate}
