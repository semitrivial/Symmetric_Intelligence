...
\begin{enumerate}
    ...
    for the function
    $f:(\mathcal O \mathcal R\mathcal A)^*\to 2^*$
    defined by
...
on the more general question of what makes a UTM ``natural''. $\sqcap$-symmetry is
natural for RL but would be irrelevant elsewhere---just
