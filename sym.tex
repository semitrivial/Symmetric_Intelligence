...
\begin{proof}
    ...
    $U$ which computes $\overline\mu$. It follows that $U$ is a vertically symmetric
    PFUTM.
\end{proof}
...
vertical symmetry is one answer to Leike and Hutter's question \cite{leike2015bad},
...
agents would get themselves into.
