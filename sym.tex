...
By definition, agent $\overline\pi$ acts as agent $\pi$ would act if $\pi$ were
confused into thinking punishments were rewards and rewards were punishments. Whatever ingenuity $\pi$ applies to maximize rewards, $\overline\pi$ applies that same
